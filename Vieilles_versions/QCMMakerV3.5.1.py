...
compt = 1
canv_quest = tk.Canvas(main, width=500, height=400,
                       scrollregion=(0, 0, 1000, len(l_types)*38))
cont_quest = tk.Frame(canv_quest)
canv_quest.grid(row=1, rowspan=6, column=5, sticky="ew")
...
bouton_start.grid(row=7, column=0)
state = tk.StringVar()
...
canv_cr.grid(row=1, rowspan=6, column=5, sticky="ew")
defilY_cr = tk.Scrollbar(main, orient='vertical',
                         command=canv_cr.yview)
defilY_cr.grid(row=1, rowspan=6, column=9, sticky='nesw')
...
canv_cr.grid(row=1, rowspan=5, column=8, sticky="ew")
...
bouton_crea_brut.grid(row=7, column=1)  # Bouton pour lancer QCMMaker V1
...
bouton_verif_data.grid(row=6, column=1)
...
case_nb_total_quest.grid(row=8, column=1)
